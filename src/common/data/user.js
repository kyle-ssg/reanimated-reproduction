...
module.exports = {
    ...
    getUserInformation: function (secretWordChoices, secretWordToken) {
        return data.post(Project.api + 'auth/userinformation', { secretWordChoices, secretWordToken });
    },
    ...
    changeSecretWord: function (word,userId) {
        word = word.toUpperCase();
        return data.post(Project.api + 'user/' + userId + '/changeSecretWord?salt=true', { secretWord1: word, secretWord2: word });
    }
};