...
declare global {
  ...
  let Flex: React.ComponentType<ReactNative.ViewProps & { value?: number }>
  let ION: React.ComponentType<
  ...
  >
  let ListItem: React.ComponentType<ReactNative.TouchableOpacityProps>
  let Container: React.ComponentType<{
    ml0?: boolean
    ml5?: boolean
    ml10?: boolean
    ml15?: boolean
  ...
  let Row: React.ComponentType<ReactNative.ViewProps & { space?: boolean }>
  ...
  let TextInput: React.ComponentType<
  ...
  let Platform:
    | ReactNative.PlatformIOSStatic
    | ReactNative.PlatformAndroidStatic
  ...
  let em: (value: number) => number
  let Image: React.ComponentType<ReactNative.ImageProps>
