...
import {
  projectPalette,
  projectStyles
} from "../app/style/project/style_variables";
declare global {
  ...
  declare let Flex: React.ComponentType<
  ReactNative.ViewProps & { value?: number }
  >;
  declare let ION: React.ComponentType<
  ...
  declare let Row: React.ComponentType<
  ReactNative.ViewProps & { space?: boolean }
  >;
  declare let TouchableOpacity: React.ComponentType<
  ...
  declare let Fade: React.ComponentType<
  ReactNative.ViewProps & { value: boolean; children: ReactNode }
  >;
