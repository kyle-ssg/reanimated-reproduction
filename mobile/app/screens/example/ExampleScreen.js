...
You are signed in with Google as
                            ...
                            <Svg
                              style={{ alignSelf: 'center' }} height="126pt" viewBox="0 -21 512 512"
                              width="126"
                            >
                                <Path d="M301 394.703v30c0 24.899-20.098 45-45 45s-45-20.101-45-45v-30c0-8.402 6.598-15 15-15h60c8.402 0 15 6.598 15 15zm0 0" fill="#4a696f" />
                                <Path d="M301 394.703v30c0 24.899-20.098 45-45 45v-90h30c8.402 0 15 6.598 15 15zm0 0" fill="#384949" />
                                <Path d="M256 19.703c-94.2 0-165 75.899-165 165 0 53.399 25.5 103.5 70.2 135 12.3 8.7 19.8 24 19.8 41.098v3.902c0 24.899 20.098 45 45 45h60c24.902 0 45-20.101 45-45v-4.8c0-16.2 8.7-31.801 23.7-43.2 42-31.5 66.3-79.5 66.3-132 0-90.601-72.898-164.7-165-165zm0 0" fill="#ffe470" />
                                <Path d="M421 184.703c0 52.5-24.3 100.5-66.3 132-15 11.399-23.7 27-23.7 43.2v4.8c0 24.899-20.098 45-45 45h-30v-390c92.102.3 165 74.399 165 165zm0 0" fill="#fdbf00" />
                                <Path d="M497 199.703h-31c-8.29 0-15-6.71-15-15 0-8.293 6.71-15 15-15h31c8.29 0 15 6.707 15 15 0 8.29-6.71 15-15 15zm0 0" fill="#f4d7af" />
                                <Path d="M46 199.703H15c-8.29 0-15-6.71-15-15 0-8.293 6.71-15 15-15h31c8.29 0 15 6.707 15 15 0 8.29-6.71 15-15 15zm0 0" fill="#faecd8" />
                                <Path d="M393.887 46.816c-5.86-5.859-5.86-15.351 0-21.21l21.21-21.211c5.86-5.86 15.352-5.86 21.212 0s5.859 15.351 0 21.21l-21.211 21.211c-5.86 5.86-15.352 5.86-21.211 0zm0 0" fill="#f4d7af" />
                                ...
                                <Path d="M415.098 365.012L393.887 343.8c-5.86-5.86-5.86-15.356 0-21.211 5.86-5.86 15.351-5.86 21.21 0l21.212 21.21c5.859 5.86 5.859 15.352 0 21.212s-15.352 5.86-21.211 0zm0 0" fill="#f4d7af" />
                                <Path d="M339.402 202.102l-79.203-52.5L284.5 101.3c3.3-6.598 1.2-14.399-4.8-18.899-6-4.199-14.098-3.601-19.2 1.801l-90 90c-3.3 3-4.8 7.5-4.5 12 .602 4.5 3 8.399 6.598 11.098l79.203 52.5-24.301 48.3c-3.3 6.602-1.2 14.403 4.8 18.903 6 4.2 14.098 3.598 19.2-1.8l90-90c3.3-3 4.8-7.5 4.5-12-.602-4.5-3-8.403-6.598-11.102zm0 0" fill="#fdbf00" />
                                <Path d="M346 213.203c.3 4.5-1.2 9-4.5 12l-85.5 85.5v-222l4.5-4.5c5.102-5.402 13.2-6 19.2-1.8 6 4.5 8.1 12.3 4.8 18.898l-24.3 48.3 79.202 52.5c3.598 2.7 5.996 6.602 6.598 11.102zm0 0" fill="#ff9f00" />
                            </Svg>
