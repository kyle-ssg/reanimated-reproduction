  ...
  render() {
      ...
      return (
          <ViewOverflow style={Styles.lightbox}>
              ...
              odio viverra nulla viverra odio viverra nulla viverra odio viverra
              nulla viverra odio viverra nulla viverra odio viverra nulla
              viverra odio viverra nulla viverra odio viverra nulla viverra
                  </H3>
                  )}
                  <H3 style={Styles.textCenter}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ac
            odio viverra nulla viverra
              ...
              <FormGroup>
                  <Button style={{ alignSelf: 'center', width: 200 }} onPress={dismiss}>
            Ok
                  </Button>
              </FormGroup>
          </ViewOverflow>
