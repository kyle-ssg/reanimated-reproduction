...
const Stack1 = () => (
  <Navigator
    ...
    initialRouteName={RouteUrls.ReportsDashboardScreen}
  >
    <Stack.Screen
      name={RouteUrls.home}
...
const Stack2 = () => (
  <Navigator
    screenOptions={defaultNavigationOptions}
    initialRouteName={RouteUrls.SeagullsScreen}
  >
    <Stack.Screen
...
const MainAppNavigator = ({ route }) => {
  return (
    <Flex>
      <Tab.Navigator
        lazy={false}
        initialRouteName={RouteUrls.generic}
        tabBar={(props) => <BottomNav {...props} />}
      >
        <Tab.Screen name={RouteUrls.home} component={Stack1} />
        <Tab.Screen name={RouteUrls.generic} component={Stack2} />
      </Tab.Navigator>
    </Flex>
  )
}
