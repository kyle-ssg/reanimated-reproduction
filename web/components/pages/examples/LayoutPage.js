...
const LayoutPage = class extends React.Component {
  ...
  render() {
      return (
          <div className="app-container container">
              ...
              <p>
          If you’re familiar with modifying variables in Sass—or any other CSS preprocessor—you’ll be right at
          ...
          Responsive Ordering
            ...
            2 of 2 (stacked on mobile)
              ...
              <p>
          When we activate Flexbox it will automatically convert each of the columns into flex items matching
