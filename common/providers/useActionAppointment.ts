...
type UseActionAppointment = {
  ...
  createActionAppointment: (data: RequestTypes['createActionAppointment'], callbacks?:Callbacks)=>void,
}

export default function useActionAppointment():UseActionAppointment {
  const {
    actionAppointment, actionAppointmentLoading, actionAppointmentSaving, actionAppointmentError } = useSelector((state:AppState)=>({
  ...
  const createActionAppointment = useCallback((data: RequestTypes['createActionAppointment'], callbacks?:Callbacks)=>{
