...
const Utils = {
  ...
  keys: {
    isUndo/* istanbul ignore next */(e:KeyboardEvent):boolean {
      if (!e) return;
      return (e.ctrlKey || e.metaKey) && e.keyCode === (e.shiftKey ? KEY_Y : KEY_Z);
    },
    ...
    isRedo/* istanbul ignore next */(e:KeyboardEvent):boolean {
      if (!e) return;
      return (e.ctrlKey || e.metaKey) && e.keyCode === (e.shiftKey ? KEY_Z : KEY_Y);
    },
    isBackspace/* istanbul ignore next */(e:KeyboardEvent):boolean { // returns bool
      if (!e) return;
      const code = (e.keyCode ? e.keyCode : e.which);
      return code === 8 && !e.shiftKey && !e.ctrlKey;
    },
    isUp/* istanbul ignore next */(e:KeyboardEvent):boolean { // returns bool
      if (!e) return;
      const code = (e.keyCode ? e.keyCode : e.which);
      return code === 38 && !e.shiftKey && !e.ctrlKey;
    },
    isDown/* istanbul ignore next */(e:KeyboardEvent):boolean { // returns bool
      if (!e) return;
      const code = (e.keyCode ? e.keyCode : e.which);
      return code === 40 && !e.shiftKey && !e.ctrlKey;
    },
    isLeft/* istanbul ignore next */(e:KeyboardEvent):boolean { // returns bool
      if (!e) return;
      const code = (e.keyCode ? e.keyCode : e.which);
      return code === 37 && !e.shiftKey && !e.ctrlKey;
    },
    isRight/* istanbul ignore next */(e:KeyboardEvent):boolean { // returns bool
      if (!e) return;
      const code = (e.keyCode ? e.keyCode : e.which);
      return code === 39 && !e.shiftKey && !e.ctrlKey;
    },
    isTab/* istanbul ignore next */(e:KeyboardEvent):boolean { // returns bool
      if (!e) return;
      const code = (e.keyCode ? e.keyCode : e.which);
      return code === 9 && !e.shiftKey && !e.ctrlKey;
    },
    isEnter/* istanbul ignore next */(e:KeyboardEvent):boolean { // returns bool
      if (!e) return;
      const code = (e.keyCode ? e.keyCode : e.which);
  ...
  toParam(obj?:Record<string, any>):string { // {min:100,max:200} -> ?min=100&max=200
    if (!obj) return '';
  ...
  fromParam(str?:string):Record<string, any> { // {min:100,max:200} <- ?min=100&max=200
  ...
  safeParseEventValue/* istanbul ignore next */(e?:SyntheticEvent):any { // safe attempt to parse form value
    if (!e) {
      return e;
    }
    if (!e.target) {
  ...
  isValidEmail(text?:string):boolean { // returns bool
